...
public class PuzzleGenerator_Runtime: MonoBehaviour
{
    ...
    public PuzzleController CreatePuzzleFromImage(Texture2D _image) 
	{
        ...
        puzzle.decomposeDistance = new Vector3(4.2f,0.5f,0);
        puzzle.decomposeToLeft = false;
        puzzle.decomposeToRight = false;
        puzzle.decomposeToTop = false;
        puzzle.decomposeToBottom = true;
