...
public class PuzzleController : MonoBehaviour 
{
    ...
    public SpriteRenderer GenerateBackground(Texture2D _image = null)
    {
        ...
        var color = new Color(255, 175, 179);
        spriteRenderer.color = new Color(255, 175, 179);
        
        var texture = new Texture2D(_image.width, _image.height);
        texture.Apply();
        
        var sprite = Sprite.Create(texture, new Rect(0.0f, 0.0f, _image.width, _image.height), new Vector2(0, 1));
